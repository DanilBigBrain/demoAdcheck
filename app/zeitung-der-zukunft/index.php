...
<!-- Reveal ---------------------------->
<a style="display: none" class="reveal-popup" data-open="modal">Click me for a modal</a>

<div class="reveal" id="modal" data-reveal>
    <img width="200px" src="assets/img/logo_background.svg" alt="Logo">

    <?php if($reveal == 1) { ?>
        <p><strong>Lieber Abonnent/ Liebe Abonnentin,</strong></p>
        <p>willkommen im Login-Bereich vom "Regionalen Tageblatt". Vielen Dank, dass Sie unser Angebot nutzen.</p>
        <p>Sie erhalten nun exklusiven Zugriff auf alle Artikel und Reportagen.</p>
        <button data-close aria-label="Close modal" class="button small">Weiter zur Website</button>
    <?php } elseif($reveal == 2) {?>
        <p><strong>Sehr geehrter Nutzer/ sehr geehrte Nutzerin,</strong></p>

        <p>Sie sind neu hier und nutzen das kostenfreie Angebot vom "Regionalen Tageblatt"</p>

        <p>Nur mit einem Abo vom "Regionalen Tageblatt" erhalten Sie exklusiven Zugriff auf alle Artikel und vieles mehr.</p>
        <button data-close aria-label="Close modal" class="button small">Weiter zur Website</button>
    <?php } elseif($reveal == 3) { ?>
        <p><strong>Sehr geehrter Nutzer/ sehr geehrte Nutzerin,</strong></p>
        ...
        <p>Nur mit einem Abo vom "Regionalen Tageblatt" erhalten Sie exklusiven Zugriff auf alle Artikel und vieles mehr.
            Mit der kostenfreien Variante stehen Ihnen nicht alle Artikel zur Verfügung.</p>
        <button data-close aria-label="Close modal" class="button small">Weiter zur Website</button>
    <?php } ?>
                    ...
                    <div class="grid-wrapper">
                        <div class="grid-container">
                            ...
                            <div class="grid-x grid-margin-x">
                                <div class="cell <?php if($ads) { echo "small-24 medium-9"; } ?> introArticle"><a href="subpage-intro.php">
                                ...
                                <?php if($ads) { ?><div class="cell small-24 medium-3">
    ...
    <script>
        ...
        var revealStatus = document.cookie.indexOf('reveal=');

        if (revealStatus == -1) {
            $('#modal').foundation('open');
            document.cookie = "reveal=opened";
        }
