...
<body>
    ...
    <?php if($billboard == true && $bb) { ?>
        ...
        <div class="ad-wrapper <?php if($stickyBillboard) { ?> sticky-ad <?php } ?>" id="billboard">
        <?php include('assets/adinfo.php'); ?>
<video  height="auto" width="100%" playsinline preload="auto" autoplay="true" loop="true" muted="muted" >
            ...
            <div class="grid-x align-top">
                              ...
                              <div class="cell">
                                ...
                                <?php if($halfPageAd == true && $hpa) { ?>
                                    <div class="ad-wrapper mobile-ad" id="hpa">
                                        <?php include('assets/adinfo.php'); ?>
                                        <video height="100%" width="100%" playsinline preload="auto" autoplay="true" loop="true" muted="muted" >
                ...
                <?php if($skyScraper == true && $skyScr) { ?>
                    <div class="hide-for-small-only ad-wrapper <?php if($stickySkyScr) { ?> sticky-ad-skyScr <?php } ?>" id="skyscraper">
                        <?php include('assets/adinfo.php'); ?>
                        <video  width="96%" playsinline preload="auto" autoplay="true" loop="true" muted="muted" >
   <source src="<?php switch($skyScr){
       case 1:
        echo $skyScraperV4;
   }?>"type="video/mp4"; codecs="theora, vorbis">
                ...
                <?php if($halfPageAd == true && $hpa) { ?>
                    <div class="hide-for-small-only ad-wrapper <?php if($stickyHPA) { ?> sticky-ad <?php } ?>" id="hpa">
                        <?php include('assets/adinfo.php'); ?>
                        <video  height="100%" playsinline width="100%"  preload="auto" autoplay="true" loop="true" muted="muted">
   <source src="<?php switch($hpa){
       case 1:
        echo $hpaV4;
   }?>" type="video/mp4"; codecs="theora, vorbis">
   ...
   <source   src="<?php switch($fooSupBan){
       case 1:
        ...
        break; case 2: 
            echo $footerSuperBannerV5;
            break; case 3: 
                echo $footerSuperBannerV6;
                break;
   }?>" type="video/mp4"; codecs="theora, vorbis">
