...
<body>
    ...
    <?php if($billboard == true && $bb) { ?>
        <div class="grid-wrapper ads <?php if($stickyBillboard == true) { ?> data-sticky-container <?php } ?>">
            <div class="grid-x collapse align-center" <?php if($stickyBillboard == true) { ?>data-sticky data-margin-top="0" data-anchor="sticky-anchor" <?php } ?>>
    ...
    <?php if($superBanner == true && $supBan) { ?>
        <div class="grid-wrapper ads <?php if($stickySuperBanner == true) { ?> data-sticky-container <?php } ?>">
            <div class="grid-x collapse align-center" <?php if($stickySuperBanner == true) { ?>data-sticky data-margin-top="0" data-anchor="sticky-anchor" <?php } ?>>
    ...
    <div class="grid-wrapper">
        <div class="grid-container">
            <div class="grid-x" id="sticky-anchor">
                ...
                <?php if($skyScraper == true && $skyScr) { ?>
                <div class="cell shrink ads hide-for-small-only" id="skyscraper">
                    <div class="ad-wrapper" data-sticky-container>
                        <div <?php if($stickySkyScr) { ?> data-sticky data-margin-top="0" data-anchor="sticky-anchor" <?php } ?>>
                            <?php include('assets/adinfo.php'); ?>
                            <img src="<?php switch ($skyScr) {
                                case 2:
                                    echo $skyScraperV2;
                ...
                <!-- Ad Desktop HPA ---------------------------->
                <?php if($halfPageAd == true && $hpa) { ?>
                <div class="cell shrink ads hide-for-small-only" id="hpa">
                    <div class="ad-wrapper" data-sticky-container>
                        <div <?php if($stickyHPA) { ?> data-sticky data-margin-top="0" data-anchor="sticky-anchor" <?php } ?>>
                            <?php include('assets/adinfo.php'); ?>
                            <img src="<?php switch ($hpa) {
                                case 2:
                                    echo $hpaV2;
