...
<body>
    ...
    <?php if($billboard == true && $bb) { ?>
        ...
        <div class="ad-wrapper <?php if($stickyBillboard) { ?> sticky-ad <?php } ?>" id="billboard">
        <?php include('assets/adinfo.php'); ?>
<video  height="auto" width="100%" preload="auto" autoplay="true" loop="true" muted="muted" >

   <source src="<?php switch($bb){
       case 1:
        echo $billboardV4;
    ...
    <?php if($superBanner == true  && $supBan) { ?>
        <div class="ad-wrapper <?php if($stickySuperBanner) { ?> sticky-ad <?php } ?>" id="superbanner">
            <?php include('assets/adinfo.php'); ?>
            <video width="728" height="90"   preload="auto" autoplay="true" loop="true" muted="muted" controls>
   <source src="<?php switch($supBan){
       case 1:
        echo $superBannerV4;
    ...
    <?php if($superBanner2 == true && $supBan) { ?>
        ...
        <div class="grid-container">
            <div class="grid-x align-top">
                              ...
                              <div class="cell">
                                ...
                                <?php if($skyScraper == true && $skyScr) { ?>
                                    <div class="ad-wrapper mobile-ad" id="skyscraper">
                                        <?php include('assets/adinfo.php'); ?>
                                        <video width="160" height="600"  preload="auto" autoplay="true" loop="true" muted="muted">
                                        <source src="<?php switch($skyScr){
                                         case 1:
                                         echo $skyScraperV4;
                                        }?>" type='video/ogg; codecs="theora, vorbis"'>
                                ...
                                <?php if($skyScraper2 == true && $skyScr) { ?>
                                    <div class="ad-wrapper mobile-ad" id="skyscraper">
                                        <?php include('assets/adinfo.php'); ?>
                                ...
                                <?php if($halfPageAd == true && $hpa) { ?>
                                    <div class="ad-wrapper mobile-ad" id="hpa">
                                        <?php include('assets/adinfo.php'); ?>
                                        <video height="100%" width="100%"  preload="auto" autoplay="true" loop="true" muted="muted" >
                                        <source src="<?php switch($hpa){
                                         case 1:
                                          echo $hpaV4;
                                          }?>" type='video/ogg; codecs="theora, vorbis"'>
              ...
              <p>Gemeinsam gejagt, gemeinsam im Krankenhaus: Angesteckt haben sich die Männer wohl, als sie den Tieren die Felle abgezogen. Nun befinden sich acht von ihnen auf der Isolierstation</p>
                ...
                <?php if($skyScraper == true && $skyScr) { ?>
                    <div class="hide-for-small-only ad-wrapper <?php if($stickySkyScr) { ?> sticky-ad-skyScr <?php } ?>" id="skyscraper">
                        <?php include('assets/adinfo.php'); ?>
                        <video  width="96%"  preload="auto" autoplay="true" loop="true" muted="muted" >
   <source src="<?php switch($skyScr){
       case 1:
        echo $skyScraperV4;
   }?>" type='video/ogg; codecs="theora, vorbis"'>
                ...
                <!-- Ad Desktop HPA ---------------------------->
                <?php if($halfPageAd == true && $hpa) { ?>
                    <div class="hide-for-small-only ad-wrapper <?php if($stickyHPA) { ?> sticky-ad <?php } ?>" id="hpa">
                        <?php include('assets/adinfo.php'); ?>
                        <video  height="100%" width="95%"  preload="auto" autoplay="true" loop="true" muted="muted">
   <source src="<?php switch($hpa){
       case 1:
        echo $hpaV4;
   }?>" type='video/ogg; codecs="theora, vorbis"'>
    ...
    <?php if($footerSuperBanner == true && $fooSupBan) { ?>
        <div class="ad-wrapper" id="footer-superbanner">
            <?php include('assets/adinfo.php'); ?>
            <video   height="100%" width="99.1%"  preload="auto" autoplay="true" loop="true" muted="muted" >
   <source   src="<?php switch($fooSupBan){
       case 1:
        echo $footerSuperBannerV4;
   }?>" type='video/ogg; codecs="theora, vorbis"'>
    ...
    <?php if($footerSuperBanner2 == true && $fooSupBan) { ?>
        <div class="ad-wrapper" id="footer-superbanner">
            <?php include('assets/adinfo.php'); ?>
